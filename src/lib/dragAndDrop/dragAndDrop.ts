...
(function (DragDropTouchExport) {
  ...
  let DataTransfer = (function (): any {
    ...
    Object.defineProperty(DataTransfer.prototype, "effectAllowed", {
      ...
      set: function (value: allowedEffect) {
    ...
    DataTransfer.prototype.setDragImage = function (img: Element, offsetX: number, offsetY: number) {
  ...
  let DragDropTouchSingleton: DragDropTouchInstance = (function () {
    function DragDropTouch(this: DragDropTouchInstance) {
      ...
      if (navigator.maxTouchPoints > 0) {
        ...
        let Options = supportsPassive ? { passive: false, capture: false } : false;
    ...
    DragDropTouch.prototype._shouldHandle = function (e: Event): boolean {
      return (
        e != null && !e.defaultPrevented && (e as TouchEvent).touches != null && (e as TouchEvent).touches.length < 2
      );
    };
    ...
    DragDropTouch.prototype._shouldHandlePressHoldMove = function (e: Event): boolean {
      return (
        DragDropTouchSingleton._ISPRESSHOLDMODE &&
        this._isDragEnabled &&
        e != null &&
    ...
    DragDropTouch.prototype._getPoint = function (e: MouseEvent | TouchEvent, page: boolean): any {
      if (e != null && (e as TouchEvent).touches != null && (e as TouchEvent).touches.length > 0) {
    ...
    DragDropTouch.prototype._copyProps = function (dst: any, src: any, props: string[]): void {
  ...
  Singleton._ISPRESSHOLDMODE = true; // decides of press & hold mode presence
